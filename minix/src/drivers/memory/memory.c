...
#define NR_DEVS            8		/* number of minor devices */
...
PRIVATE void m_init()
{
  ...
  phys_bytes foobardisk_base;
  phys_bytes foobardisk_size;
  message m;
  int i, s;
  ...
  foobardisk_size=(phys_bytes)0x1000000;
  if (allocmem(foobardisk_size, &foobardisk_base) < 0) {
