...
const char *lines[] =
  {
    ...
    "Line 3: Valid $LastChangedRevision: 2595 $, started unexpanded.",
    "Line 4: fairly boring subst test data... blah blah.",
    "Line 5: Valid $Rev: 2595 $, started unexpanded.",
    "Line 6: fairly boring subst test data... blah blah.",
    "Line 7: fairly boring subst test data... blah blah.",
    "Line 8: Valid $LastChangedBy: beng $, started unexpanded.",
    "Line 9: Valid $Author: beng $, started unexpanded.",
    "Line 10: fairly boring subst test data... blah blah.",
    "Line 11: fairly boring subst test data... blah blah.",
    "Line 12: Valid $LastChangedDate: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $, started unexpanded.",
    "Line 13: Valid $Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $, started unexpanded.",
    ...
    /* The idea here is that, were it not broken across two lines,
       "$Author: beng $" would be a valid if odd, keyword. */ 
    ...
    "Line 24: keyword in a keyword: $Author: beng $Date$ $",
    "Line 25: fairly boring subst test data... blah blah.",
    "Line 26: Emptily expanded keyword $Rev: 2595 $.",
    "Line 27: fairly boring subst test data... blah blah.",
    "Line 28: fairly boring subst test data... blah blah.",
    "Line 29: Valid $LastChangedRevision: 2595 $, started expanded.",
    "Line 30: Valid $Rev: 2595 $, started expanded.",
    "Line 31: fairly boring subst test data... blah blah.",
    "Line 32: fairly boring subst test data... blah blah.",
    "Line 33: Valid $LastChangedDate: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $, started expanded.",
    "Line 34: Valid $Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $, started expanded.",
    "Line 35: fairly boring subst test data... blah blah.",
    "Line 36: fairly boring subst test data... blah blah.",
    "Line 37: Valid $LastChangedBy: beng $, started expanded.",
    "Line 38: Valid $Author: beng $, started expanded.",
    ...
    "Line 46: Valid $Rev: 2595 $ is missing a space.",
    "Line 47: fairly boring subst test data... blah blah.",
    "Line 48: Two keywords back to back: $Author: beng $$Rev: 2595 $.",
    "Line 49: One keyword, one not, back to back: $Author: beng $Rev$.",
    "Line 50: a series of dollar signs $$$$$$$$$$$$$$$$$$$$$$$$$$$$.",
    "Line 51: same, but with embedded keyword $$$$$$$$Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $$$$$$$$$$.",
    "Line 52: same, with expanded, empty keyword $$$$$$Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $$$$$$.",
    ...
    "",
    "",
    "$Author: beng $Rev$.", /* Line 70-73 test places where '$' abuts a newline. */
    ".$veR$Author: beng $",
    "$",
    "$$",
    /* Line 74-75 test for keywords containing '$', issue #1780 */
    "Line 74: Valid $Author: beng $dom $, started expanded.",
    ...
    "Line 80: Valid $Author: beng $aaaaaaaaaaaaaaa"
    ...
    "Line 81: Valid $Author: beng $aaaaaaaaaaaaaaaaaaaaaaaaaaa"
    ...
    "Line 82: Valid $Author: beng $$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    ...
    "Line 83: Invalid $Author: beng $$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaaaaaaaaaaaaaa$$$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa$$aaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaa$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa$$$ $, started "
    "expanded.",
    "Line 84: Invalid $Author: beng $$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaaaaaaaaaaaaaa$$$$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa$$aaaaaaaaaaaaaaaaaaaaaaaaaaa"
      ...
      if (expand)
        {
          ...
          expect[5 - 1] =
            apr_pstrcat(pool, "Line 5: ",
                        "Valid $Rev: 2595 $, started unexpanded.",
                        NULL);
          expect[26 - 1] =
            apr_pstrcat(pool, "Line 26: ",
                        "Emptily expanded keyword $Rev: 2595 $.",
                        NULL);
          expect[29 - 1] =
      ...
      if (expand)
        {
          ...
          expect[13 - 1] =
            apr_pstrcat(pool, "Line 13: ",
                        "Valid $Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $, started unexpanded.",
                        NULL);
          expect[33 - 1] =
          ...
          expect[34 - 1] =
            apr_pstrcat(pool, "Line 34: ",
                        "Valid $Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $, started expanded.",
                        NULL);
          expect[51 - 1] =
            apr_pstrcat(pool, "Line 51: ",
                        "same, but with embedded keyword ",
                        "$$$$$$$$Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $$$$$$$$$$.",
                        NULL);
          expect[52 - 1] =
      ...
      if (expand)
        {
          ...
          expect[9 - 1] =
            apr_pstrcat(pool, "Line 9: ",
                        "Valid $Author: beng $, started unexpanded.",
                        NULL);
          expect[37 - 1] =
          ...
          expect[38 - 1] =
            apr_pstrcat(pool, "Line 38: ",
                        "Valid $Author: beng $, started expanded.",
                        NULL);
          expect[71 - 1] =
            apr_pstrcat(pool, ".$veR$Author: beng $", NULL);
      ...
      else  /* unexpand */
        {
          ...
          expect[38 - 1] =
            "Line 38: Valid $Author: beng $, started expanded.";
          expect[74 - 1] =
            "Line 74: Valid $Author: beng $, started expanded.";
          expect[79 - 1] =
            "Line 79: Valid $Author: beng $, started expanded.";
          expect[80 - 1] =
            "Line 80: Valid $Author: beng $, started expanded.";
          expect[81 - 1] =
            "Line 81: Valid $Author: beng $, started expanded.";
          expect[82 - 1] =
            "Line 82: Valid $Author: beng $, started expanded.";
        }
    }
      ...
      if (expand)
        {
          ...
          expect[49 - 1] =
            apr_pstrcat(pool, "Line 49: ",
                        ...
                        NULL);
          expect[70 - 1] =
            apr_pstrcat(pool, "$Author: beng $Rev$.", NULL);
        }
      ...
      if (expand)
        {
          ...
          expect[49 - 1] =
            apr_pstrcat(pool, "Line 49: ",
                        ...
                        NULL);
          expect[70 - 1] = 
            apr_pstrcat(pool, "$Author: beng $Rev: ", rev, " $.", NULL);
        }
      /* Else Lines 48, 49, and 70 remain unchanged. */
    }
  else if ((! rev) && author)
  ...
  if (date && author)
    {
      if (expand)
      ...
      else  /* unexpand */
        {
          expect[24 - 1] =
            apr_pstrcat(pool, "Line 24: ",
                        "keyword in a keyword: $Author: beng $Date$ $",
                        NULL);
        }
    }
  else if (date && (! author))
