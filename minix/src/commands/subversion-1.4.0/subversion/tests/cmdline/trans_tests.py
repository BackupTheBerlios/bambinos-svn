...
def setup_working_copy(wc_dir, value_len):
  ...
  svntest.main.file_append (author_rev_unexp_path, "$Author: beng $\n$Rev: 2595 $")
  svntest.main.file_append (author_rev_exp_path, "$Author: beng $\n$Rev: 2595 $")
  svntest.main.file_append (url_unexp_path, "$URL$")
  svntest.main.file_append (url_exp_path, "$URL: blah $")
  svntest.main.file_append (id_unexp_path, "$Id: trans_tests.py 2595 2006-09-27 09:07:52Z beng $")
  svntest.main.file_append (id_exp_path, "$Id: trans_tests.py 2595 2006-09-27 09:07:52Z beng $")
  svntest.main.file_append (bogus_keywords_path, "$Arthur$\n$Rev0$")
  svntest.main.file_append (embd_author_rev_unexp_path,
                            "one\nfish\n$Author: beng $ two fish\n red $Rev: 2595 $\n fish")
  svntest.main.file_append (embd_author_rev_exp_path,
                            "blue $Author: beng $ fish$Rev: 2595 $\nI fish")
  ...
  svntest.main.file_append (id_with_space_path, "$Id: trans_tests.py 2595 2006-09-27 09:07:52Z beng $")
  svntest.main.file_append (id_exp_with_dollar_path, 
                   "$Id: trans_tests.py 2595 2006-09-27 09:07:52Z beng $_sign 1 2006-06-10 11:10:00Z jrandom $")
...
def keywords_from_birth(sbox):
  ...
  lines = fp.readlines()
  if not ((len(lines) == 1)
          and (re.match("\$Id: trans_tests.py 2595 2006-09-27 09:07:52Z beng $_sign [^$]* jrandom \$", 
                        lines[0]))):
...
def cat_keyword_expansion(sbox):
  ...
  # Set up A/mu to do $Rev: 2595 $ keyword expansion
  svntest.main.file_append (mu_path , "$Rev: 2595 $\n$Author: beng $")
  svntest.actions.run_and_verify_svn(None, None, [],
