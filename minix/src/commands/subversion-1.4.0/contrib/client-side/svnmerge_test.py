...
class TestCase_kwextract(unittest.TestCase):
    def test_basic(self):
        self.assertEqual(svnmerge.kwextract("$Rev: 2595 $"), "134 rasky")
        self.assertEqual(svnmerge.kwextract("$Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $"),
                         "2005-09-25 13:45 CET+1")

    def test_failure(self):
        self.assertEqual(svnmerge.kwextract("$Rev: 2595 $"), "<unknown>")
        self.assertEqual(svnmerge.kwextract("$Date: 2006-09-27 11:07:52 +0200 (Wed, 27 Sep 2006) $"), "<unknown>")
